...
import 'package:openapi/src/api/creators_api.dart';
...
class Openapi {
  ...
  /// Get CreatorsApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  CreatorsApi getCreatorsApi() {
    return CreatorsApi(dio, serializers);
  }
